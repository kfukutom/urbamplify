...
function Content() {
  return (
    <div style={styles.content}>
      <Section number="I" title="Getting Started 🚀" backgroundColor="#f0f0f0">
        ...
        <section id="navigating-documentation">
          ...
          <p style={{paddingTop: '10px'}}>
            For more information, please refer to the <a style={{textDecoration: 'underline'}}href="#platform-components">Platform Components</a> section.
            This product was founded by a group of University of Michigan Taubman College students, all interested in the physical interaction of spaces and the digital interaction of data.
            Coming from a background in working at top companies including Ford Motor Company, Auto Desk, Kittelson & Associates, etc., this team was built upon the idea of creating a platform that could be used by all.
            Backed by students, venture capitalists, and professors, this platform is designed to be the next big thing in the world of data analytics.
          </p>
        </section>
      ...
      <Section number="II" title="User/ Developer Guide 🚀" backgroundColor="#e0e0e0">
        <section id="what-is-our-platform">
          <h2 style={styles.sectionHeading}>What is Our Platform?</h2>
          <p style={{paddingTop: '10px', paddingBottom: '10px'}}>
            Our platform is a cutting-edge solution designed for advanced AI-powered analytics. It offers scalable, high-performance data processing for various data types, enabling real-time analytics with low latency. At its core are advanced AI algorithms that provide precise data analysis, complemented by intuitive interfaces for data visualization and system management. To streamline complex operations, we've integrated automated workflows that can handle even the most intricate processes.
      ...
      <Section number="III" title="For Administrators" backgroundColor="#e0e0e0">
        <section id="what-is-our-platform">
          <h2 style={styles.sectionHeading}>What is Our Platform?</h2>
          <p style={{paddingTop: '10px', paddingBottom: '10px'}}>
            Our platform is a cutting-edge solution designed for advanced AI-powered analytics. It offers scalable, high-performance data processing for various data types, enabling real-time analytics with low latency. At its core are advanced AI algorithms that provide precise data analysis, complemented by intuitive interfaces for data visualization and system management. To streamline complex operations, we've integrated automated workflows that can handle even the most intricate processes.
...
function Section({ number, title, backgroundColor, children }) {
  return (
    <div style={{ ...styles.section, backgroundColor }}>
      <h1 style={styles.mainHeading}>{number}. {title}</h1>
      {children}
    </div>
  );
}
